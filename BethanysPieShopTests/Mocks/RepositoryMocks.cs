...
namespace BethanysPieShopTests.Mocks
{
    ...
    {
        // We create a Mock version of the IPieRepository by using the Mock-framework
        public static Mock<IPieRepository> GetPieRepository()
        {
            ...
            // Here we create a new mock instance of the IPieRepository, do some setup and then return the mocked version:
        ...
        // We create a Mock version of the ICategoryRepository by using the Mock-framework
        public static Mock<ICategoryRepository> GetCategoryRepository()
        {
            ...
            // Here we create a new mock instance of the ICategoryRepository, do some setup and then return the mocked version:
            var mockCategoryRepoository = new Mock<ICategoryRepository>();
            mockCategoryRepoository.Setup(repo => repo.AllCategories).Returns(categories);

            return mockCategoryRepoository;
